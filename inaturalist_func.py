...
class ReadTFRecords(object):
    def __init__(
            ...
            num_threads=8, buffer_size=256, shuffle_file=False,
...
########################################################################
def read_inaturalist(key='train', batch_size=64, image_size=299, target_size=299, do_augment=False, buffer_size=2000):
    """ This function reads the iNaturalist 2019 dataset.

    :param key: train, val or test
    :param batch_size:
    :param image_size: the image size
    :param target_size: the image size, if different from target size, the image will be resized
