...
flags.DEFINE_string('SYSPATH', '/home/mshaik/update2/', 'Default working folder.')
flags.DEFINE_string('DEFAULT_IN', '/data/cephfs/punim0811/Datasets/iNaturalist/tfrecords_299/', 'Default input folder.')
flags.DEFINE_string('DEFAULT_OUT', '/home/mshaik/update2/', 'Default output folder.')
flags.DEFINE_string(
    'DEFAULT_DOWNLOAD', '/data/cephfs/punim0811/Datasets/iNaturalist/',
    'Default folder for downloading large datasets.')
flags.DEFINE_string(
    'INCEPTION_V1',
    '/home/mshaik/update2/inceptionv1_for_inception_score.pb',
    'Folder that stores Inception v1 model.')
flags.DEFINE_string(
    'INCEPTION_V3',
    '/home/mshaik/update2/classify_image_graph_def.pb',
    'Folder that stores Inception v1 model.')
